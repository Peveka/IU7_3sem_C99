...
{
    int arr[] = {-5, 2, -8, 0, 9, -1};
    int expected[] = {-8, -5, -1, 0, 2, 9};

    mysort(arr, 6, sizeof(int), cmp_int);
...
START_TEST(mysort_large_array)
{
    ...
    mysort(arr, 100, sizeof(int), cmp_int);
...
Suite *mysort_suite(void)
{
    ...
    tcase_add_test(tc_core, mysort_large_array);
